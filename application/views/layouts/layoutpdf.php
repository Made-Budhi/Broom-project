...
<html lang="en"><head>
    ...
    <main style="margin: 0;">
        <table>
            ...
            <tr>
                <td>Perihal</td>
                <td>: <bold><?php echo $data['perihal'] ?></bold></td>
            </tr>
        </table>
        ...
        <p>Dengan Hormat,</p>
        <p>Sehubung dengan diadakan kegiatan <?php echo $data['kegiatan'] ?> yang diselenggarakan oleh <?php  echo $data['penyelenggara'] ?>.
            Maka dengan ini kami selaku panitia pelaksana memohon izin untuk meminjam dan menggunakan Ruangan <?php echo $data['nama-ruangan'] ?>
            pada:</p>

        <table class="tab">
            <tr>
                <td style="width:175px;">Hari / Tanggal</td>
                <td style="width:400px;">: <?php echo format_indo($data['tanggal-mulai']) . ' - ' . format_indo($data['tanggal-selesai']) ?></td>
            </tr>
