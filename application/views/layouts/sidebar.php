  ...
  <div class="menubar p-3 h-100 d-flex flex-column fit-content bg-white">
    ...
    <div class="menubutton mt-4 h-100 text-center d-flex flex-md-column text-md-center">
      <a href="<?= site_url('Cdashboard') ?>"
         class="btn gabarito btn-primary py-2 mb-3 fs-5 rounded-3 text-start w-100">
      ...
      <a href="<?= site_url('cmenupeminjam/reservasi') ?>"
         class="btn gabarito py-2 mb-3 fs-5 rounded-3 text-start w-100 ">
        <i class="fa-solid fa-file-circle-plus fa-lg p-2"></i>
        <span>Reservasi</span>
      </a>

      <a href="#" class="btn gabarito py-2 mb-3 fs-5 rounded-3 text-start w-100 ">
        <i class="fa fa-bell fa-lg p-2"></i>
      ...
      <a href="#" class="btn gabarito py-2 mb-3 fs-5 rounded-3 text-start w-100 hide">
